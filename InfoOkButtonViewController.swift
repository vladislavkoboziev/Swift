//
//  InfoOkButtonViewController.swift
//  armor-privacy-guard-ios
//
//  Created by John on 05.08.2020.
//  Copyright © 2020 evolutn.io. All rights reserved.
//

import UIKit

class InfoOkButtonViewController: UIViewController {
    ...
    private func setupConstraints() {
        ...
        topInfoBodyLabel.bottomAnchor.constraint(equalTo: infoOkButton.topAnchor, constant: -20.0).isActive = true
        ...
        infoOkButton.trailingAnchor.constraint(equalTo: infoTopView.trailingAnchor, constant: -10.0).isActive = true
